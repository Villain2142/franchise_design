...
def get_context(context):
    ...
    try:
        ...
        camps_list = frappe.db.sql(
            """select * from `tabRobothink Program` where publish=1 and program_type = "Camps" """, as_dict=1)
        camps_list = camps_list[::-1]


        context.camps_list = camps_list
